...
export function Sidebar({ isCollapsed }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 h-screen border-r border-[#1b2740] bg-[#0f172a] text-white transition-all duration-300 ease-in-out lg:relative lg:z-auto",
        ...
        <div className="flex h-full flex-col">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    "hover:bg-[#1b2b45] hover:text-white",
                    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                    isActive ? "bg-[#1f3a66] text-white shadow-sm" : "text-white/75",
                  )}
                >
                  <item.icon
                    className={cn(
          ...
          <div className="border-t border-white/10 p-4">
            <Button
              variant="ghost"
              className={cn(
                "group w-full justify-start gap-3 text-white/75 transition-all duration-200 hover:bg-[#1b2b45] hover:text-white",
